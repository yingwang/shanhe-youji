...
const FOOD_CARDS = [
  { id: 'f1', name: '北京烤鸭', city: 'beijing', cost: 3, cuisine: '京菜' },
  { id: 'f2', name: '炸酱面', city: 'beijing', cost: 1, cuisine: '京菜' },
  { id: 'f3', name: '豆汁焦圈', city: 'beijing', cost: 1, cuisine: '京菜' },
  { id: 'f4', name: '涮羊肉', city: 'beijing', cost: 3, cuisine: '京菜' },
  { id: 'f5', name: '锅包肉', city: 'harbin', cost: 1, cuisine: '东北菜' },
  { id: 'f6', name: '铁锅炖大鹅', city: 'harbin', cost: 3, cuisine: '东北菜' },
  ...
  { id: 'f13', name: '盐水鸭', city: 'nanjing', cost: 1, cuisine: '苏菜' },
  ...
  { id: 'f17', name: '松鼠桂鱼', city: 'suzhou', cost: 3, cuisine: '苏菜' },
  { id: 'f18', name: '苏式汤面', city: 'suzhou', cost: 1, cuisine: '苏菜' },
  { id: 'f19', name: '桂花鸡头米', city: 'suzhou', cost: 1, cuisine: '甜品' },
  { id: 'f20', name: '东坡肉', city: 'hangzhou', cost: 3, cuisine: '浙菜' },
  { id: 'f21', name: '龙井虾仁', city: 'hangzhou', cost: 3, cuisine: '浙菜' },
  { id: 'f22', name: '西湖醋鱼', city: 'hangzhou', cost: 3, cuisine: '浙菜' },
  ...
  { id: 'f26', name: '瓷泥煨鸡', city: 'jingdezhen', cost: 3, cuisine: '赣菜' },
  { id: 'f27', name: '碱水粑', city: 'jingdezhen', cost: 1, cuisine: '小吃' },
  { id: 'f28', name: '冷粉', city: 'jingdezhen', cost: 1, cuisine: '小吃' },
  { id: 'f29', name: '臭鳜鱼', city: 'huangshan', cost: 3, cuisine: '徽菜' },
  ...
  { id: 'f34', name: '武昌鱼', city: 'wuhan', cost: 3, cuisine: '鄂菜' },
  { id: 'f35', name: '排骨藕汤', city: 'wuhan', cost: 2, cuisine: '鄂菜' },
  { id: 'f36', name: '剁椒鱼头', city: 'changsha', cost: 3, cuisine: '湘菜' },
  ...
  { id: 'f44', name: '双皮奶', city: 'guangzhou', cost: 3, cuisine: '甜品' },
  ...
  { id: 'f51', name: '海蛎煎', city: 'xiamen', cost: 3, cuisine: '闽菜' },
  { id: 'f52', name: '佛跳墙', city: 'fuzhou', cost: 1, cuisine: '闽菜' },
  { id: 'f53', name: '鱼丸', city: 'fuzhou', cost: 1, cuisine: '闽菜' },
  { id: 'f54', name: '锅边糊', city: 'fuzhou', cost: 1, cuisine: '小吃' },
  { id: 'f55', name: '面线糊', city: 'quanzhou', cost: 3, cuisine: '闽菜' },
  ...
  { id: 'f59', name: '啤酒鱼', city: 'guilin', cost: 3, cuisine: '桂菜' },
  ...
  { id: 'f64', name: 'biangbiang面', city: 'xian', cost: 3, cuisine: '陕菜' },
  ...
  { id: 'f73', name: '钟水饺', city: 'chengdu', cost: 3, cuisine: '川菜' },
  ...
  { id: 'f80', name: '过桥米线', city: 'kunming', cost: 3, cuisine: '滇菜' },
  ...
  { id: 'f91', name: '桶子鸡', city: 'kaifeng', cost: 3, cuisine: '豫菜' },
  { id: 'f92', name: '炒凉粉', city: 'kaifeng', cost: 3, cuisine: '小吃' },
  ...
  { id: 'f100', name: '崂山绿茶', city: 'qingdao', cost: 3, cuisine: '茶饮' },
  ...
  { id: 'f105', name: '绍兴黄酒', city: 'shaoxing', cost: 3, cuisine: '酒饮' },
  ...
  { id: 'f110', name: '丝娃娃', city: 'guiyang', cost: 3, cuisine: '小吃' },
  ...
  { id: 'f114', name: '纳西烤鱼', city: 'lijiang', cost: 3, cuisine: '滇菜' },
  ...
  { id: 'f120', name: '牦牛肉汤锅', city: 'jiuzhaigou', cost: 3, cuisine: '藏羌菜' },
  ...
  { id: 'f124', name: '翘脚牛肉', city: 'leshan', cost: 3, cuisine: '川菜' },
  { id: 'f125', name: '文昌鸡', city: 'sanya', cost: 2, cuisine: '琼菜' },
  { id: 'f126', name: '清补凉', city: 'sanya', cost: 1, cuisine: '甜品' },
  { id: 'f127', name: '椰子鸡', city: 'sanya', cost: 3, cuisine: '琼菜' },
